...
def in_mapper_combiner(partition):
...
if __name__ == "__main__":
    ...
    combined_locally = word_file_pairs.mapPartitions(in_mapper_combiner)

    word_file_counts = combined_locally.reduceByKey(lambda x, y: x + y)
